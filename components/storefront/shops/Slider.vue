  ...
  <div>
    ...
    <div class="carousel-inner relative overflow-hidden w-full">
      ...
      <!---banner---->
            ...
            <div class="flex-1 ...">
              <div class="bg-cover bg-no-repeat bg-#E5E7EB flex content-center items-center justify-center"
                style="background-image: url('https://savoy-webstack.netdna-ssl.com/wp-content/uploads/2015/08/slider-wall-clock-alt.jpg');">
              </div>
            </div>
            <div class="flex-1 ...">
      ...
      <div class="flex">
        <div class="flex-1 ...">
           <div class="bg-cover bg-no-repeat bg-#E5E7EB flex content-center items-center justify-center"
            style="background-image: url('https://savoy-webstack.netdna-ssl.com/wp-content/uploads/2015/08/slider-pendant-lighting-alt.jpg');">
       </div>
        </div>
         <div class="flex-1 ...">
            <div class="container relative mx-auto">
